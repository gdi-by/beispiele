                                        ...
                                        <td style="border:0px; float: right;" align="right">
                                            <a>
                                                <xsl:attribute name="href">
                                                    <xsl:copy-of select="$urlprefix"/>/getcapabilities/CapabilitiesViewer?wms_url=<xsl:value-of select="$orGetC"/>&amp;version=1.1.1&amp;format=html&amp;link=true</xsl:attribute>URL zu dieser Seite</a>
                                        </td>
                                    </tr>                        
                                </table>
                            </xsl:if>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:for-each select="WMT_MS_Capabilities/Capability/Layer//Layer">                                    
                                            <xsl:value-of select="substring('- - - - - - - - - - - - - - - - - - - - - - - - ',1,count(ancestor::*)*5-15)"/>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Nord: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/LatLonBoundingBox/@maxy"/>
                                        <br />
                                        Ost: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/LatLonBoundingBox/@maxx"/>
                                        <br />
                                        Süd: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/LatLonBoundingBox/@miny"/>
                                        <br />
                                        West: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/LatLonBoundingBox/@minx"/>
                                        <br />
                                        <br />


                                        Begrenzung bezogen auf: <xsl:value-of select="/WMT_MS_Capabilities/Capability/Layer/BoundingBox/@SRS"/>
                                        <br />
                                        Nord: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/BoundingBox/@maxy"/>
                                        <br />
                                        Ost: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/BoundingBox/@maxx"/>
                                        <br />
                                        Süd: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/BoundingBox/@miny"/>
                                        <br />
                                        West: <xsl:value-of select="WMT_MS_Capabilities/Capability/Layer/BoundingBox/@minx"/>
                                        <br />                                
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Geographische Begrenzung:<br />
                                                Nord: <xsl:value-of select="LatLonBoundingBox/@maxy"/>
                                                <br />
                                                Ost: <xsl:value-of select="LatLonBoundingBox/@maxx"/>
                                                <br />
                                                Süd: <xsl:value-of select="LatLonBoundingBox/@miny"/>
                                                <br />
                                                West: <xsl:value-of select="LatLonBoundingBox/@minx"/>
                                                <br />
                                                <br />

                                                <xsl:for-each select="BoundingBox">
                                                    Begrenzung bezogen auf: <xsl:value-of select="@SRS"/>
                                                    <br />
                                                    Nord: <xsl:value-of select="@maxy"/>
                                                    <br />
                                                    Ost: <xsl:value-of select="@maxx"/>
                                                    <br />
                                                    Süd: <xsl:value-of select="@miny"/>
                                                    <br />
                                                    West: <xsl:value-of select="@minx"/>
                                                    <br />
                                                    <br />
                                                </xsl:for-each>
                                            </td>
