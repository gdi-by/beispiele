...
<!--    
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Capabilities Viewer GDI-BY (XSLT WFS 2.0.0 -> HTML)
        ...
        <html>
            ...
            <body>
                <center>
                                        ...
                                        <b>
                                            <a>
                                                <xsl:attribute name="href">
                                                    <xsl:copy-of select="$urlprefix"/>/getcapabilities/CapabilitiesViewer?ows_url=<xsl:value-of select="$orGetC"/>&amp;service=wfs&amp;version=2.0.0&amp;format=html
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>URL zu weiteren Kontaktinformationen: 
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="wfs:DefaultCRS"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <xsl:for-each select="wfs:OtherCRS">
                                            <xsl:value-of select="."/>
                                            <br />
                                        </xsl:for-each>
                                    </td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:Parameter[@name='AcceptVersions']/ows:AllowedValues/ows:Value">
                                        <xsl:value-of select="."/>
                                        <br/>
                                    </xsl:for-each>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:Parameter[@name='AcceptFormats']/ows:AllowedValues/ows:Value">
                                        <xsl:value-of select="."/>
                                        <br/>
                                    </xsl:for-each>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='GetCapabilities']/ows:Parameter[@name='Sections']/ows:AllowedValues/ows:Value">
                                        <xsl:value-of select="."/>
                                        <br/>
                                    </xsl:for-each>
                                </td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='DescribeFeatureType']/ows:Parameter[@name='outputFormat']/ows:AllowedValues/ows:Value">
                                        <xsl:value-of select="."/>
                                        <br/>
                                    </xsl:for-each>
                                    <xsl:if test="not(wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='DescribeFeatureType']/ows:Parameter[@name='outputFormat']/ows:AllowedValues)">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='GetFeature']/ows:Parameter[@name='outputFormat']/ows:AllowedValues/ows:Value">
                                        <xsl:value-of select="."/>
                                        <br/>
                                    </xsl:for-each>
                                    <xsl:if test="not(wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='GetFeature']/ows:Parameter[@name='outputFormat']/ows:AllowedValues)">
                                        <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Parameter[@name='outputFormat']/ows:AllowedValues/ows:Value">
                                            <xsl:value-of select="."/>
                                            <br/>
                                        </xsl:for-each>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Operation[@name='GetFeature']/ows:Parameter[@name='resultType']/ows:AllowedValues/ows:Value">
                                        <xsl:value-of select="."/>
                                        <br/>
                                    </xsl:for-each>
                                </td>
                    ...
                    <table>
                        <caption>
                            Erweiterte Capabilities für INSPIRE-Downloaddienst
                            <br />
                            (nach Technical Guidance Documents Version 3.0)
                        </caption>
                        <thead>
                            <tr>
                                <th scope="col" width="30%">Eigenschaften
                                    <br />INSPIRE
                                </th>
                                <th scope="col">Beschreibung</th>
                            </tr>
                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                <th scope="col" width="30%">Constraint</th>
                        ...
                        <tbody>
                            ...
                            <xsl:for-each select="wfs:WFS_Capabilities/ows:OperationsMetadata/ows:Constraint">
                                <xsl:choose>
                                    <xsl:when test="./@name='QueryExpressions'">
                                        <tr>
                                            <td>
                                                <xsl:value-of select="./@name"/>
                                            </td>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/fes:Filter_Capabilities/fes:Scalar_Capabilities/fes:LogicalOperators/fes:LogicalOperator">
                                        <xsl:value-of select="./@name"/>
                                        <br />
                                    </xsl:for-each>	
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/fes:Filter_Capabilities/fes:Scalar_Capabilities/fes:ComparisonOperators/fes:ComparisonOperator">
                                        <xsl:value-of select="./@name"/>
                                        <br />
                                    </xsl:for-each>	
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/fes:Filter_Capabilities/fes:Spatial_Capabilities/fes:GeometryOperands/fes:GeometryOperand">
                                        <xsl:value-of select="./@name"/>
                                        <br />
                                    </xsl:for-each>	
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/fes:Filter_Capabilities/fes:Spatial_Capabilities/fes:SpatialOperators/fes:SpatialOperator">
                                        <xsl:value-of select="./@name"/>
                                        <br />
                                    </xsl:for-each>	
                                </td>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td>Operationen</td>
                                <td>
                                    <xsl:for-each select="wfs:WFS_Capabilities/fes:Filter_Capabilities/fes:Functions/fes:Function">
                                        <xsl:value-of select="./@name"/>
                                        <br />
                                    </xsl:for-each>	
                                </td>
